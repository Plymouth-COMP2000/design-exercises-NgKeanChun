...
// **FIX: Room annotations are removed as they are no longer needed.**
public class Menu implements DisplayableItem {
    private int id;
    private String name;
    private String description;
    private double price;
    private int imageDrawableId; // For default/placeholder images
    private String imageUri; // For user-selected images
    private String category;

    // No-argument constructor
    public Menu() {}

    // Constructor for creating new menu items easily
    public Menu(String name, String description, double price, int imageDrawableId, String category) {
        this.name = name;
        this.description = description;
        this.price = price;
        this.imageDrawableId = imageDrawableId;
        this.imageUri = null; // Default to null for this constructor
